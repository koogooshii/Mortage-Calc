...
import { RentVsBuyAnalyzerComponent } from './components/rent-vs-buy-analyzer/rent-vs-buy-analyzer.component';
import { PaymentFrequencyVisualizerComponent } from './components/payment-frequency-visualizer/payment-frequency-visualizer.component';
...
@Component({
  ...
  imports: [
    ...
    RentVsBuyAnalyzerComponent,
    PaymentFrequencyVisualizerComponent,
...
export class AppComponent {
  ...
  pageTitle = computed(() => {
    ...
    if (currentMode === 'rent-vs-buy') return 'Rent vs. Buy Analyzer';
    if (currentMode === 'payment-frequency') return 'Payment Frequency Visualizer';
    if (currentMode === 'knowledge-base') return 'Mortgage Knowledge Base';
